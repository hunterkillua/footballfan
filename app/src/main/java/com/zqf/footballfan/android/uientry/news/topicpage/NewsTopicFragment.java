...
public class NewsTopicFragment extends Fragment {
    ...
    private void initListView() {
        ...
        ////////////////////////
        mAdapter = new NewsTopicAdapter(getActivity(), dataList);
        mAdapter.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                if (v.getTag() instanceof TopicData) {
                    TopicData topicData = (TopicData) v.getTag();
                    UiEntryTo.toTopicActivity(getActivity());
                }
            }
        });
